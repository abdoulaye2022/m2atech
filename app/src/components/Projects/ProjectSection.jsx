...
const getProjects = (t) => [
  {
    ...
    tags: ["Next.js", "React", "CMS", "Google Cloud Storage", "SEO", "Newsletter", "Responsive Design"],
    icon: FaNewspaper,
    category: t('projects.projects.lintellectois.category'),
    images: [
      "/img/projects/lintellectois1.png",
      "/img/projects/lintellectois2.png",
      "/img/projects/lintellectois3.png",
    ],
    features: t('projects.projects.lintellectois.features'),
    liveUrl: "https://www.lintellectois.com",
  },
  {
    key: "binbabmakka",
    title: t('projects.projects.binbabmakka.title'),
    description: t('projects.projects.binbabmakka.description'),
    tags: ["Next.js", "React", "Booking System", "Multilingual", "Responsive Design", "SEO", "Payment Integration"],
    icon: FaKaaba,
    category: t('projects.projects.binbabmakka.category'),
    images: [
      "/img/projects/binbabmakka1.png",
      "/img/projects/binbabmakka2.png",
      "/img/projects/binbabmakka3.png",
    ],
    features: t('projects.projects.binbabmakka.features'),
    liveUrl: "https://www.binbabmakka.com",
  },
  {
    key: "fourPlusOne",
    title: t('projects.projects.fourPlusOne.title'),
    description: t('projects.projects.fourPlusOne.description'),
    tags: ["Next.js", "React", "Bilingual", "SEO", "Responsive Design", "Lead Generation"],
    icon: FaHardHat,
    category: t('projects.projects.fourPlusOne.category'),
    images: [
      "/img/projects/4plusone1.png",
      "/img/projects/4plusone2.png",
      "/img/projects/4plusone3.png",
    ],
    features: t('projects.projects.fourPlusOne.features'),
    liveUrl: "https://www.4plusone.ca",
  },
  {
    key: "garopro",
    title: t('projects.projects.garopro.title'),
    description: t('projects.projects.garopro.description'),
    tags: ["Next.js", "React", "SaaS", "Stripe", "Multi-tenant", "Bilingual", "PIPEDA", "Mobile App"],
    icon: FaTools,
    category: t('projects.projects.garopro.category'),
    images: [
      "/img/projects/garopro1.png",
      "/img/projects/garopro2.png",
      "/img/projects/garopro3.png",
    ],
    features: t('projects.projects.garopro.features'),
    liveUrl: "https://www.garopro.ca",
  },
  {
    key: "m2abot",
    title: t('projects.projects.m2abot.title'),
    description: t('projects.projects.m2abot.description'),
    tags: ["Next.js", "React", "AI/ML", "Claude API", "SaaS", "Bilingual", "Lead Generation", "PIPEDA"],
    icon: FaComments,
    category: t('projects.projects.m2abot.category'),
    images: [
      "/img/projects/m2abot1.png",
      "/img/projects/m2abot2.png",
      "/img/projects/m2abot3.png",
    ],
    features: t('projects.projects.m2abot.features'),
    liveUrl: "https://m2abot.ai",
  },
  {
    key: "saura",
    title: t('projects.projects.saura.title'),
    description: t('projects.projects.saura.description'),
    tags: ["Next.js", "React", "AI/ML", "Speech-to-Text", "AWS", "QR Code", "SaaS", "Real-time"],
    icon: FaLanguage,
    category: t('projects.projects.saura.category'),
    images: [
      "/img/projects/saura1.png",
      "/img/projects/saura2.png",
      "/img/projects/saura3.png",
    ],
    features: t('projects.projects.saura.features'),
    liveUrl: "https://www.saura.ca",
  },
  {
    key: "beydoumAuto",
  ...
  {
    key: "sahelcode",
    title: t('projects.projects.sahelcode.title'),
    description: t('projects.projects.sahelcode.description'),
    tags: ["Next.js", "React", "AI/ML", "Claude API", "CLI", "Bilingual", "SaaS", "Mobile Money"],
    icon: FaLaptopCode,
    category: t('projects.projects.sahelcode.category'),
    images: [
      "/img/projects/sahelcode1.png",
      "/img/projects/sahelcode2.png",
      "/img/projects/sahelcode3.png",
    ],
    features: t('projects.projects.sahelcode.features'),
    liveUrl: "https://www.sahelcode.dev",
  },
  {
    key: "kidsecure",
