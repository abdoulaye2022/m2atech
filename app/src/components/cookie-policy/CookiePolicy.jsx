    ...
    <Box py={16} bg="var(--color-bg-primary)">
      <Container maxW="container.lg">
        <Heading as="h1" size="2xl" mb={8} color="var(--color-text-primary)" fontFamily="var(--font-display)">
          Cookie <Box as="span" className="gradient-text">Policy</Box>
        </Heading>
        ...
        <Box mb={12}>
          ...
          <Text color="var(--color-text-secondary)">
            For more information, visit <Link href="https://www.aboutcookies.org" color="#ff5d22" isExternal>aboutcookies.org</Link>.
          </Text>
        </Box>
